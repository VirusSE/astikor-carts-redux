    ...
    public void init(final Context mod) {
        ...
        new AssembledTextureFactory()
            .add(ResourceLocation.fromNamespaceAndPath(AstikorCarts.ID, "textures/entity/animal_cart.png"), new AssembledTexture(64, 64)
                ...
                .add(new Material(ResourceLocation.parse("block/stripped_spruce_log"), 16)
                    .fill(54, 54, 10, 10, Material.R0, 0, 2)
                )
                .add(new Material(ResourceLocation.parse("block/oak_log"), 16)
                    .fill(0, 21, 60, 4, Material.R90)
                    .fill(46, 60, 8, 4, Material.R90)
                )
                .add(new Material(ResourceLocation.parse("block/stone"), 16)
                    .fill(62, 55, 2, 9)
                )
            )
            ...
            .add(ResourceLocation.fromNamespaceAndPath(AstikorCarts.ID, "textures/entity/supply_cart.png"), new AssembledTexture(64, 64)
                ...
                .add(new Material(ResourceLocation.parse("block/composter_side"), 16)
                    .fill(16, 47, 44, 5, Material.R0, -2, 1)
                    .fill(16, 54, 38, 5, Material.R0, -2, -6)
                )
                .add(new Material(ResourceLocation.parse("block/composter_top"), 16)
                ...
                .add(new Material(ResourceLocation.parse("block/dirt"), 16)
                    .fill(0, 45, 16, 17)
                )
            )
            .register(mod.modBus());
